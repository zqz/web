...
var FileWhere = struct {
	...
	Alias:       whereHelperstring{field: "\"files\".\"alias\""},
	Hash:        whereHelperstring{field: "\"files\".\"hash\""},
	Slug:        whereHelperstring{field: "\"files\".\"slug\""},
...
var (
	...
	fileColumnsWithoutDefault = []string{"size", "name", "alias", "hash", "slug", "content_type", "updated_at"}
...
func (fileL) LoadThumbnails(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFile interface{}, mods queries.Applicator) error {
	var slice []*File
	var object *File
	...
	query := NewQuery(
		qm.From(`thumbnails`),
		qm.WhereIn(`thumbnails.file_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on thumbnails")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for thumbnails")
	}
...
func (o *File) AddThumbnails(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Thumbnail) error {
	var err error
